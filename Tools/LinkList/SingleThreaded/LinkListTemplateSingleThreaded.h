...
public:
    ...
    BOOL RemoveItem(CLinkListItemTemplate<T>* Item,BOOL DeleteObjectMemory);
    BOOL RemoveItemFromItemData(T* pObject);
    BOOL RemoveItemFromItemData(T* pObject,BOOL DeleteObjectMemory);
    BOOL RemoveAllItems();
    BOOL RemoveAllItems(BOOL DeleteObjectsMemory);
